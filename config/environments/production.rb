...
Rails.application.configure do
  ...
  # Include generic and useful information about system operation, but avoid logging too
  # much information to avoid inadvertent exposure of personally identifiable
  # information (PII).
